...
(setq org-capture-templates
	...
	("i" "Inbox" entry (file "~/gtd/inbox.org")
	 "* TODO %?\n %i\n")
	("j" "jw")
	("jb" "Bible Reading" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/bible-reading.org"))
	("jm" "Microphone" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/microphone.org"))
	("jr" "Return Visit" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/return-visit.org"))
	("jc" "Cong. Bible Study Reader" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/cong-bible-study-reader.org"))
	("jt" "Talk" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/talk.org"))
	("jw" "Watchtower" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/watchtower-reader.org"))
	("jk" "Kingdom Cleaning" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/cleaning.org"))
	("ji" "Initial Call" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/initial-call.org"))
	("ja" "Audio Visual")
	("jam" "Audio Visual Main" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/audio-visual.org"))
	("jaa" "Audio Visual Assistant" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/audio-visual-assistant.org"))
	("jab" "Broadcast" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/broadcast.org"))
	("jp" "Prayer/Platform")
	("jpo" "Opening Prayer" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/opening-prayer.org"))
	("jpc" "Closing Prayer" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/closing-prayer.org"))
	("jpp" "Platform" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
	 (file "~/gtd/templates/platform.org"))
	("p" "Project" entry (file+headline "~/gtd/org-gtd-tasks.org" "Projects")
